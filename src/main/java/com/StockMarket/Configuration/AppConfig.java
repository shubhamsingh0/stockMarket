package com.StockMarket.Configuration;
...
@ComponentScans(value={@ComponentScan("com.StockMarket.DAO"),
		@ComponentScan("com.StockMarket.Service")
})
public class AppConfig {
	 @Autowired
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
	      ...
	      factoryBean.setPackagesToScan("com.StockMarket.Entity");
	      return factoryBean;
	   }
